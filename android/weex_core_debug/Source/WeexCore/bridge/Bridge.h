...
namespace WeexCore {
  ...
  public:
    ...
    virtual int callAddEvent(int &pageId, const char *ref, const char *event) = 0;

    virtual int callRemoveEvent(int &pageId, const char *ref, const char *event) = 0;

    virtual int callCreateBody(int &pageId, const char *componentType, const char *ref,
    ...
    virtual int callAddElement(int &pageId, const char *componentType, const char *ref,
    ...
    virtual int callLayout(int &pageId, const char *ref,
                           int top, int bottom, int left, int right,
                           int height, int width) = 0;

    virtual int callUpdateStyle(int &pageId, const char *ref,
                                std::vector<std::pair<std::string, std::string>> *style,
                                std::vector<std::pair<std::string, std::string>> *margin,
                                std::vector<std::pair<std::string, std::string>> *padding,
                                std::vector<std::pair<std::string, std::string>> *border) = 0;

    virtual int callUpdateAttr(int &pageId, const char *ref,
                               std::vector<std::pair<std::string, std::string>> *attrs) = 0;

    virtual int callCreateFinish(int &pageId) = 0;

    virtual int callRemoveElement(int &pageId, const char *ref) = 0;

    virtual int callMoveElement(int &pageId, const char *ref, const char *parentRef, int index) = 0;
  };
} //end WeexCore
#endif //Bridge_h
