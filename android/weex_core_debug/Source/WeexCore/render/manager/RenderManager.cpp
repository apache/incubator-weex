...
namespace WeexCore {
  ...
  bool RenderManager::AddRenderObject(const int &pageId, const int &parentRef,
...
#if RENDER_LOG
    LOGD("[RenderManager] AddRenderObject >>>> pageId: %d, parentRef: %d, index: %d, dom data: %s",
         pageId, parentRef, index, data.c_str());
#endif
  ...
  bool RenderManager::RemoveRenderObject(const int &pageId, const int &ref) {
...
#if RENDER_LOG
    LOGD("[RenderManager] RemoveRenderObject >>>> pageId: %d, ref: %d", pageId,
         ref);
#endif
  ...
  bool RenderManager::MoveRenderObject(const int &pageId, const int &ref,
...
#if RENDER_LOG
    LOGD("[RenderManager] MoveRenderObject >>>> pageId: %d, ref: %d, parentRef: %d, index: %d",
  ...
  bool RenderManager::UpdateAttr(const int &pageId, const int &ref,
...
#if RENDER_LOG
    LOGD("[RenderManager] UpdateAttr >>>> pageId: %d, ref: %d, data: %s",
         pageId, ref, data.c_str());
#endif
  ...
  bool RenderManager::UpdateStyle(const int &pageId, const int &ref,
                                  const std::string &data) {
    RenderPage *page = this->GetPage(pageId);
    if (page == nullptr)
      return false;
...
#if RENDER_LOG
    LOGD("[RenderManager] UpdateStyle >>>> pageId: %d, ref: %d, data: %s",
         pageId, ref, data.c_str());
#endif
  ...
  bool RenderManager::AddEvent(const int &pageId, const int &ref,
...
#if RENDER_LOG
    LOGD("[RenderManager] AddEvent >>>> pageId: %d, ref: %d, event: %s",
         pageId, ref, event.c_str());
#endif
  ...
  bool RenderManager::RemoveEvent(const int &pageId, const int &ref,
                                  const std::string &event) {
    RenderPage *page = this->GetPage(pageId);
    if (page == nullptr)
      return false;
...
#if RENDER_LOG
    LOGD("[RenderManager] RemoveEvent >>>> pageId: %d, ref: %d, event: %s",
         pageId, ref, event.c_str());
#endif
