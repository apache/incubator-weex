...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/d10ef48204aeac94bcc6f0c2942f9de3", [], function(__weex_require__, __weex_exports__, __weex_module__){
	    ...
	    ready: function() {
	      ...
	      function getConfig(obj) {
	        for (var key in obj) if (obj.hasOwnProperty(key)) {
	          if (typeof obj[key] == 'object') getConfig(obj[key]);
	          configs.push({config: key + ':' + obj[key]});
	        }
	      }
	      getConfig(config);
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	        {
	          "type": "text",
	          "repeat": function () {return this.configs},
	          "attr": {
	...
	;__weex_bootstrap__("@weex-component/d10ef48204aeac94bcc6f0c2942f9de3", {
