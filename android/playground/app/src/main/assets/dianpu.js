...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/a281caadd8a2c9bdeb28c2373d6f3e85", [], function(__weex_require__, __weex_exports__, __weex_module__){
	...
	;
	    ...
	    __weex_module__.exports = {
	        data: function () {return {
	            shop_config:{
	                "pageId":"1","pathInfo":"newitems","userId":"2572349714","user_id":"2572349714"
	            },
	...
	;__weex_bootstrap__("@weex-component/a281caadd8a2c9bdeb28c2373d6f3e85", {
	  ...
	  "children": [
	    ...
	    },
	    {
	      ...
	      "attr": {
	        ...
	        "format_time": function () {return this.item.formatTime},
	        "link": function () {return this.item.detailUrl},
	        "biz_id": function () {return this.item.itemId},
	        "btn_type": "single",
	...
	;
	    __weex_module__.exports = {
	        ...
	        ready: function() {
	            ...
	            // 在H5中调用windvane的api，而在native中调用模块
	            vm.status = 'calendar-unset';
	            var platform = vm.$getConfig().env.platform;
	            if (platform.toUpperCase() !== 'WEB') {
	                vm.$call('shopWXCalendar', 'checkReminder', {
	                    businessId:vm.bizid,
	        ...
	        methods: {
	            setCalendar: function() {
	                ...
	                if (vm.status == 'calendar-unset') {
	                    if (platform.toUpperCase() !== 'WEB') {
	                        vm.$call('shopWXCalendar', 'addReminder', {
	                            businessId:vm.bizid,
	                            sourceId:vm.sourceId,
	                            title:vm.title,
	                            startTime:vm.format_time,
	                            endTime:vm.format_time,
	                            remind:180,
	                            link:vm.link
	                        }, function() {
	                            vm.$call('modal', 'toast', {
	                                'message': '日历提醒设置成功 系统将会提前3分钟提醒您',
	                                'duration': 1
	                            });
	                            vm.status = 'calendar-set';
	                        });
	                    ...
	                    if (platform.toUpperCase() !== 'WEB') {
	                        vm.$call('shopWXCalendar', 'cancelReminder', {
	                            businessId:vm.bizid,
	                            sourceId:vm.sourceId
	                        }, function() {
	                            vm.$call('modal', 'toast', {
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	        ...
	        },
	        {
	          ...
	          "attr": {
	            "bizid": function () {return this.first_item.itemId},
	            "title": function () {return this.first_item.title},
	            "format_time": function () {return this.first_item.formatTime},
	            "remind": function () {return this.first_item.remind},
	            "link": function () {return this.first_item.detailUrl}
	          },
	    ...
	    },
	    {
	      ...
	      "children": [
	        ...
	        },
	        {
	          ...
	          "attr": {
	            "bizid": function () {return this.second_item.itemId},
	            "title": function () {return this.second_item.title},
	            "format_time": function () {return this.second_item.formatTime},
	            "end_time": function () {return this.second_item.endTime},
	            "remind": function () {return this.second_item.remind},
	            "link": function () {return this.second_item.detailUrl}
	          },
