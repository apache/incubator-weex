...
public class WXPageActivity extends WXBaseActivity implements IWXRenderListener, Handler.Callback, WXSDKInstance.NestedInstanceInterceptor {
  ...
  private void registerBroadcastReceiver() {
    ...
    filter.addAction(IDebugProxy.ACTION_DEBUG_INSTANCE_REFRESH);
    filter.addAction(IDebugProxy.ACTION_INSTANCE_RELOAD);
  ...
  public class RefreshBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      if (IDebugProxy.ACTION_INSTANCE_RELOAD.equals(intent.getAction()) ||
              IDebugProxy.ACTION_DEBUG_INSTANCE_REFRESH.equals(intent.getAction())) {
