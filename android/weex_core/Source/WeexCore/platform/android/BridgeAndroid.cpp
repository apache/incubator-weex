...
jobject
BridgeAndroid::callNativeModule(jstring &jInstanceId, jstring &jmodule, jstring &jmethod, jbyteArray &jArgString,
                                jbyteArray &jOptString) {
  JNIEnv *env = getJNIEnv();
  ...
  jobject result = env->CallObjectMethod(jThis, jCallNativeModuleMethodId, jInstanceId, jmodule, jmethod,
...
void BridgeAndroid::callNativeComponent(jstring &jInstanceId, jstring &jcomponentRef, jstring &jmethod,
  ...
  env->CallVoidMethod(jThis, jCallNativeComponentMethodId, jInstanceId, jcomponentRef, jmethod, jArgString,
                      jOptString);
  env->DeleteLocalRef(jInstanceId);
...
int BridgeAndroid::callCreateBody(jstring &jInstanceId, jbyteArray &jTaskString, jstring &jCallback) {
  ...
  int flag = env->CallIntMethod(jThis, jCallCreateBodyMethodId, jInstanceId, jTaskString, jCallback);
  if (flag == -1) {
...
int BridgeAndroid::callUpdateFinish(jstring &instanceId, jbyteArray &taskString,
  ...
  int flag = env->CallIntMethod(jThis, jCallUpdateFinishMethodId, instanceId, taskString, callback);
  if (flag == -1) {
...
int BridgeAndroid::callCreateFinish(jstring &instanceId, jbyteArray &taskString,
  ...
  int flag = env->CallIntMethod(jThis, jCallCreateFinishMethodId, instanceId, taskString, callback);
  if (flag == -1) {
...
int BridgeAndroid::callRefreshFinish(jstring &instanceId, jbyteArray &taskString,
  ...
  int flag = env->CallIntMethod(jThis, jCallRefreshFinishMethodId, instanceId, taskString, callback);
  if (flag == -1) {
    LOGE("instance destroy JFM must stop callNative");
  }
  env->DeleteLocalRef(instanceId);
...
int BridgeAndroid::callUpdateAttrs(jstring &instanceId, jstring &ref,
  ...
  int flag = env->CallIntMethod(jThis, jCallUpdateAttrsMethodId, instanceId, ref, taskString, callback);
  if (flag == -1) {
...
int BridgeAndroid::callUpdateStyle(jstring &instanceId, jstring &ref,
  ...
  int flag = env->CallIntMethod(jThis, jCallUpdateStyleMethodId, instanceId, ref, taskString, callback);
  if (flag == -1) {
...
int BridgeAndroid::callMoveElement(jstring &instanceId, jstring &ref, jstring &parentref,
  ...
  int flag = env->CallIntMethod(jThis, jCallMoveElementMethodId, instanceId, ref, parentref, index, callback);
  if (flag == -1) {
    LOGE("instance destroy JFM must stop callRemoveElement");
  }
...
int BridgeAndroid::callRemoveEvent(jstring &instanceId,
  ...
  int flag = env->CallIntMethod(jThis, jCallRemoveEventMethodId, instanceId, ref, event, Callback);
  if (flag == -1) {
    LOGE("instance destroy JFM must stop callRemoveElement");
  }
  env->DeleteLocalRef(instanceId);
