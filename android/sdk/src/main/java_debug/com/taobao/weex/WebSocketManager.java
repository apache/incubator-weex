...
/**
 * Created by lixinke on 16/5/10.
 */
public class WebSocketManager {

  private static WebSocketManager ourInstance = new WebSocketManager();
  private Vector<OnSocketListener> mSocketListeners;
  ...
  private WebSocketManager() {
    mSocketListeners=new Vector<>();
  }
  public void registerSocketListener(OnSocketListener listener){
    if(listener!=null){
