...
class BottomRightCorner extends BorderCorner {
  ...
  protected RectF getRoundCornerOval() {
    return new RectF(getBorderBox().width() - (2 * getCornerOuterRadius() - getPreBorderWidth() / 2),
                     getBorderBox().height() - (2 * getCornerOuterRadius() - getPostBorderWidth() / 2),
  ...
  protected PointF getRoundCornerEnd() {
    return new PointF(getBorderBox().width() - getCornerOuterRadius(),
                      getBorderBox().height() - getPostBorderWidth() / 2);
  }
}
