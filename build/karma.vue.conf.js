...
module.exports = function (config) {
  config.set({
    ...
    exclude: ['../html5/test/render/vue/helper/*.js', '../html5/test/render/vue/vender/**/*.js', '../html5/test/render/vue/data/**/*.js'],
    singleRun: false,
    // singleRun: true,
    ...
    plugins: ['karma-coverage', 'karma-mocha', 'karma-mocha-reporter', 'karma-phantomjs-launcher', 'karma-rollup-preprocessor', 'karma-sinon-chai'
