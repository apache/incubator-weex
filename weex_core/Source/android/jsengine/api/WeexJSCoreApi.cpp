...
//#endif
//
//        return WeexCoreManager::getInstance()->getJSBridge()->onCallNativeModule(
...
////    Bridge_Impl_Android::getInstance()->handlePostMessage(vimId, data);
//}
//
//void
...
////    Bridge_Impl_Android::getInstance()->handleDispatchMessage(clientId, data, callback, vmId);
//}
