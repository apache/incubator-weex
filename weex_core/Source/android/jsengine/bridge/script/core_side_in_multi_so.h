...
#ifndef WEEXV8_MULTI_SO_CORE_SIDE_H
#define WEEXV8_MULTI_SO_CORE_SIDE_H
...
namespace bridge {
namespace js {
class CoreSideInMultiSo : public WeexCore::ScriptBridge::CoreSide {
 public:
  explicit CoreSideInMultiSo(){};
  explicit CoreSideInMultiSo(FunctionsExposedByCore *functions_exposed_by_core)
      : functions_exposed_by_core_(functions_exposed_by_core){};
  inline void set_functions_exposed_by_core(
      FunctionsExposedByCore *functions_exposed_by_core) {
    functions_exposed_by_core_ = functions_exposed_by_core;
  }
  ~CoreSideInMultiSo() override{};
...
#endif  // WEEXV8_MULTI_SO_CORE_SIDE_H
