...
//                                          jlong ptr){
//  WeexCoreManager::getInstance()->getPlatformBridge()->core_side()->BindMeasurementToRenderObject(ptr);
//}
//
//static void OnInstanceClose(JNIEnv *env, jobject jcaller, jstring instanceId) {
//  WeexCoreManager::getInstance()->getPlatformBridge()->core_side()->OnInstanceClose(
...
//  WeexCoreManager::getInstance()->getPlatformBridge()->core_side()->SetDefaultHeightAndWidthIntoRootDom(
//          jString2StrFast(env, instanceId), defaultWidth, defaultHeight, isWidthWrapContent,
//          isHeightWrapContent);
//}
//
//static void SetRenderContainerWrapContent(JNIEnv* env, jobject jcaller, jboolean wrap, jstring instanceId) {
//  WeexCoreManager::getInstance()->getPlatformBridge()->core_side()->SetRenderContainerWrapContent(
//          jString2StrFast(env, instanceId), wrap);
//}
//
//// Call on main thread
...
//
//  std::vector<int64_t> temp = WeexCoreManager::getInstance()->getPlatformBridge()->core_side()->GetFirstScreenRenderTime(
//          jString2StrFast(env, instanceId));
//
//  if (temp.empty()) {
...
//  jlongArray jTemp = env->NewLongArray(3);
//
//  std::vector<int64_t> temp = WeexCoreManager::getInstance()->getPlatformBridge()->core_side()->GetRenderFinishTime(
//          jString2StrFast(env, instanceId));
//  if (temp.empty()) {
...
//  return WeexCoreManager::getInstance()->getPlatformBridge()->core_side()->NotifyLayout(jString2StrFast(env, instanceId));
//}
//
////Notice that this method is invoked from JS thread.
//static void ForceLayout(JNIEnv *env, jobject jcaller, jstring instanceId) {
//  WeexCoreManager::getInstance()->getPlatformBridge()->core_side()->ForceLayout(jString2StrFast(env, instanceId));
//}
//
//// call on main thread
//static void SetStyleWidth(JNIEnv *env, jobject jcaller,
//                          jstring instanceId, jstring ref, jfloat value) {
//  WeexCoreManager::getInstance()->getPlatformBridge()->core_side()->SetStyleWidth(jString2StrFast(env, instanceId), jString2StrFast(env, ref), value);
//}
//
//// call on main thread
...
//                           jstring instanceId, jstring ref, jfloat value) {
//
//  WeexCoreManager::getInstance()->getPlatformBridge()->core_side()->SetStyleHeight(jString2StrFast(env, instanceId), jString2StrFast(env, ref), value);
//}
//
//static void SetMargin(JNIEnv *env, jobject jcaller,
//                      jstring instanceId, jstring ref, jint edge, jfloat value) {
//  WeexCoreManager::getInstance()->getPlatformBridge()->core_side()->SetMargin(jString2StrFast(env, instanceId), jString2StrFast(env, ref), edge, value);
//}
//
//static void SetPadding(JNIEnv *env, jobject jcaller,
//                       jstring instanceId, jstring ref, jint edge, jfloat value) {
//  WeexCoreManager::getInstance()->getPlatformBridge()->core_side()->SetPadding(jString2StrFast(env, instanceId), jString2StrFast(env, ref), edge, value);
//
//}
//
//
...
//                        jstring instanceId, jstring ref, jint edge, jfloat value) {
//  WeexCoreManager::getInstance()->getPlatformBridge()->core_side()->SetPosition(jString2StrFast(env, instanceId), jString2StrFast(env, ref), edge, value);
//
//}
//
//static void MarkDirty(JNIEnv *env, jobject jcaller,
//                      jstring instanceId, jstring ref, jboolean dirty) {
//  WeexCoreManager::getInstance()->getPlatformBridge()->core_side()->MarkDirty(jString2StrFast(env, instanceId), jString2StrFast(env, ref));
//
//}
//
//static void RegisterCoreEnv(JNIEnv *env, jobject jcaller, jstring key, jstring value) {
//  WeexCoreManager::getInstance()->getPlatformBridge()->core_side()->RegisterCoreEnv(jString2StrFast(env, key), jString2StrFast(env, value));
//}
//
//static void SetViewPortWidth(JNIEnv *env, jobject jcaller, jstring instanceId, jfloat value) {
//  WeexCoreManager::getInstance()->getPlatformBridge()->core_side()->SetViewPortWidth(jString2StrFast(env, instanceId), value);
//}
...
////  }
//  WeexCoreManager::getInstance()->getPlatformBridge()->BindMeasurementToRenderObject(ptr);
//}
//
//static void OnInstanceClose(JNIEnv *env, jobject jcaller, jstring instanceId) {
...
//  jlongArray jTemp = env->NewLongArray(3);
//
//  std::vector<int64_t> temp = WeexCoreManager::getInstance()->getPlatformBridge()->GetFirstScreenRenderTime(
//          jString2StrFast(env, instanceId));
//
//  if (temp.empty()) {
//    if (jFirstScreenRenderTime != nullptr) {
...
//  jlongArray jTemp = env->NewLongArray(3);
//
//  std::vector<int64_t> temp = WeexCoreManager::getInstance()->getPlatformBridge()->GetRenderFinishTime(
//          jString2StrFast(env, instanceId));
//  if (temp.empty()) {
//    if (jRenderFinishTime != nullptr) {
//      env->DeleteGlobalRef(jRenderFinishTime);
...
//  //}
//  return WeexCoreManager::getInstance()->getPlatformBridge()->NotifyLayout(jString2StrFast(env, instanceId));
//}
//
////Notice that this method is invoked from JS thread.
//static void ForceLayout(JNIEnv *env, jobject jcaller, jstring instanceId) {
...
////  }
// WeexCoreManager::getInstance()->getPlatformBridge()->ForceLayout(jString2StrFast(env, instanceId));
//}
//
//// call on main thread
//static void SetStyleWidth(JNIEnv *env, jobject jcaller,
...
// WeexCoreManager::getInstance()->getPlatformBridge()->SetStyleWidth(jString2StrFast(env, instanceId), jString2StrFast(env, ref), value);
//}
//
//// call on main thread
//static void SetStyleHeight(JNIEnv *env, jobject jcaller,
//                           jstring instanceId, jstring ref, jfloat value) {
//
//  WeexCoreManager::getInstance()->getPlatformBridge()->SetStyleHeight(jString2StrFast(env, instanceId), jString2StrFast(env, ref), value);
//
//  //RenderObject *render = page->GetRenderObject(jString2StrFast(env, ref));
//  //if (render == nullptr)
//  //  return;
...
//  //}
//  //page->set_is_dirty(true);
//  WeexCoreManager::getInstance()->getPlatformBridge()->SetMargin(jString2StrFast(env, instanceId), jString2StrFast(env, ref), edge, value);
//}
//
//static void SetPadding(JNIEnv *env, jobject jcaller,
//                       jstring instanceId, jstring ref, jint edge, jfloat value) {
...
//  //}
//  //page->set_is_dirty(true);
// WeexCoreManager::getInstance()->getPlatformBridge()->SetPadding(jString2StrFast(env, instanceId), jString2StrFast(env, ref), edge, value);
//
//}
//
//
...
//  //}
//  //page->set_is_dirty(true);
// WeexCoreManager::getInstance()->getPlatformBridge()->SetPosition(jString2StrFast(env, instanceId), jString2StrFast(env, ref), edge, value);
//
//}
//
//static void MarkDirty(JNIEnv *env, jobject jcaller,
...
////    render->markDirty();
////  }
//  WeexCoreManager::getInstance()->getPlatformBridge()->MarkDirty(jString2StrFast(env, instanceId), jString2StrFast(env, ref));
//
//}
//
//static void RegisterCoreEnv(JNIEnv *env, jobject jcaller, jstring key, jstring value) {
...
//  WeexCoreManager::getInstance()->getPlatformBridge()->RegisterCoreEnv(jString2StrFast(env, key), jString2StrFast(env, value));
//}
//
//static void SetViewPortWidth(JNIEnv *env, jobject jcaller, jstring instanceId, jfloat value) {
//  //RenderPage *page = RenderManager::GetInstance()->GetPage(jString2StrFast(env, instanceId));
...
// WeexCoreManager::getInstance()->getPlatformBridge()->SetViewPortWidth(jString2StrFast(env, instanceId), value);
//}
...
//  static_cast<AndroidSide*>(WeexCoreManager::getInstance()->getPlatformBridge()->platform_side())->setGlobalWMRef(jWMThis);
