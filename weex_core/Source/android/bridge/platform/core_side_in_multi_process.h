...
#ifndef WEEX_PROJECT_CORE_SIDE_IN_MULTI_PROCESS_H
#define WEEX_PROJECT_CORE_SIDE_IN_MULTI_PROCESS_H
...
namespace WeexCore {
class CoreSideInMultiProcess : public PlatformBridge::CoreSide {
 public:
  CoreSideInMultiProcess() : sender_(nullptr) {}
  virtual ~CoreSideInMultiProcess() {}
  ...
  const char *ExecJSOnInstance(const char *instanceId,
...
#endif  // WEEX_PROJECT_CORE_SIDE_IN_MULTI_PROCESS_H
