...
#ifndef WEEX_PROJECT_CORE_SIDE_IN_SIMPLE_H
#define WEEX_PROJECT_CORE_SIDE_IN_SIMPLE_H

#include "base/common.h"
#include "core/bridge/platform_bridge.h"

namespace WeexCore {
class CoreSideInSimple : public PlatformBridge::CoreSide {
 public:
  CoreSideInSimple() {}
...
#endif  // WEEX_PROJECT_CORE_SIDE_IN_SIMPLE_H
