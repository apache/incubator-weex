(this.nativeLog || function(s) {console.log(s)})('START JS FRAMEWORK 0.22.0, Build 2017-09-20 19:41.');
...
var framework_weex_event = createCommonjsModule(function (module) {
      ...
      for (propKey in nextProps) {
        ...
        if (propKey === STYLE) {
          ...
          if (typeof nextProp === 'function') {
            var params = nextProps[propKey.slice(2).toLowerCase() + 'EventParams'];
            _host2.default.driver.addEventListener(this$1.getNativeNode(), propKey.slice(2).toLowerCase(), nextProp, params);
          }
...
var Driver = {
  ...
  addEventListener: function addEventListener(node, eventName, eventHandler, params) {
...
var Rax = unwrapExports(framework_weex_event);
