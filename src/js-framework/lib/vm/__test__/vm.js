...
describe('generate virtual dom for a single vm', () => {
  ...
  it('generate an element tree with repeat', () => {
    ...
    expect(vm._app).equal(app)
    expect(vm.x).eql('<some image url>')
    expect(vm.list).eql([{uid: 1, x: 1}, {uid: 2, x: 2}, {uid: 3}])
      ...
      template: {
        ...
        children: [
          {type: 'prev'},
          {
            ...
            repeat: function () {return this.list}, trackBy: 'uid',
            type: 'image', attr: {src: function () {return this.x}}
          },
          {type: 'next'}
        ]
...
describe('generate dom actions', () => {
  ...
  it('received create body and add element actions', (done) => {
  ...
  it('received actions for a template with if & repeat', (done) => {
  ...
  it('received actions for element updates', (done) => {
  ...
  it('received actions for components', (done) => {
  ...
  it('received actions for complicated components', (done) => {
  ...
  it('received actions for add a tree element', (done) => {
