(this.nativeLog || function(s) {console.log(s)})('START JS FRAMEWORK 0.24.5, Build 2018-02-26 19:31. (Vue: 2.5.11-weex.1, Rax: 0.4.20)');
...
var subversion = {"framework":"0.24.5","transformer":">=0.1.5 <0.5"};
...
function getJSFMVersion () {
  ...
  return "0.24.5" // eslint-disable-line
}
