...
function fireEvent$2 (document, nodeId, type, event, domChanges, params) {
...
function callback$2 (document, callbackId, data, ifKeepAlive) {
 ...
 */
function registerModules$1 (newModules) {
  var loop = function ( name ) {
    if (!weexModules[name]) {
      weexModules[name] = {};
    }
 ...
 */
function registerComponents$1 (newComponents) {
