    ...
    <panel title="auto-play" type="primary">
      <panel title="auto-play = false" padding-body="0">
        <slider class="slider" append="tree"
          ...
          <slider-page v-for="v in sliders[1].sliderPages" :items="v.items" :key="0"></slider-page>
        </slider>
      </panel>
      <panel title="auto-play = true" padding-body="0">
        <slider class="slider" append="tree"
          ...
          <indicator class="indicator"></indicator>
          <slider-page v-for="v in sliders[0].sliderPages" :items="v.items" :key="0"></slider-page>
        </slider>
      </panel>
    </panel>
    ...
    <panel title="Indicator" type="primary">
      ...
      <panel title="itemColor & itemSelectedColor" padding-body="0">
        <slider class="slider" append="tree"
          ...
          <slider-page v-for="v in sliders[2].sliderPages" :items="v.items" :key="0"></slider-page>
        </slider>
      </panel>
