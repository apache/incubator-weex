...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ready: function ready() {
	    ...
	    var fsize = this.$el('fsize');
	    console.log('fsize:', fsize);

	    var rect = dom.getComponentRect(fsize, function (info) {
	      console.log('run callback', info);
	    });
	    dom.getComponentRect(this.$el('fheight'), function (info) {
	      console.log('font-height', info);
	    });
	    dom.getComponentRect(this.$el('lineh'), function (info) {
	      console.log('line-height', info);
	    });
	    dom.getComponentRect('viewport', function (info) {
	      console.log('viewport', info);
	    });
	    dom.getComponentRect('invalid', function (info) {
	      console.log('invalid', info);
	    });

	    setTimeout(function () {
	      dom.getComponentRect(fsize, function (info) {
	        console.log('run    callback', info);
	      });
	    }, 2000);

	    console.log('getComponentRect:', rect);
	  }
	};}
	/* generated by weex-loader */
