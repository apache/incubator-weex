 ...
 *
 *  @return A block that takes a result, and WXComponentCallbackType
 **/
@property (nonatomic, copy) void (^WXComponentCallback)(_Nonnull id result, WXComponentCallbackType callbackType);
