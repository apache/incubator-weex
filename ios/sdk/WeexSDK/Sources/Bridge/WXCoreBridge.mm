...
{    
    ...
    void IOSSide::ReportException(const char *page_id, const char *func, const char *exception)
    {
        do {
            ...
            if (func && (strcmp(func, "CreatePageWithContent") == 0 || strcmp(func, "DestroyExecutor") == 0 || strcmp(func, "RefreshInstance") == 0
                || strcmp(func, "InvokeCallback") == 0 || strcmp(func, "FireEvent") == 0 || strcmp(func, "UpdateComponentData") == 0)) {
