...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    MainViewController *demo = [[MainViewController alloc] init];
...
- (void)initWeexSDK {
    [WXAppConfiguration setAppGroup:@"ApacheWeex"];
    [WXAppConfiguration setAppName:@"AppShell"];
